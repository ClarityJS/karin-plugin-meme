...
export const meme = karin.command(await createRegExp(), async (e) => {
    ...
    try {
        const result = await Meme.make(e, memeKey, min_texts, max_texts, min_images, max_images, defText, args_type, userText, isShortcut, shortcutKeyWoerd);
