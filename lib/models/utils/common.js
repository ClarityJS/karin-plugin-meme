import { buffer, logger } from 'node-karin';
 ...
 */
export async function getAvatar(e, userList) {
 ...
 *
 */
export async function getNickname(e, qq) {
    if (!qq || !e)
        return '未知';
    try {
        if (e.isGroup) {
...
export async function getGender(e, qq) {
    if (!qq || !e)
        return 'unknown';
    try {
        if (e.isGroup) {
 ...
 */
export async function getImage(e) {
 ...
 */
export async function addStat(key, number) {
 ...
 */
export async function getStatAll() {
