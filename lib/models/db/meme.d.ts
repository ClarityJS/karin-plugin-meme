 ...
 */
export declare function add(key: string, info: MemeData, keyWords: MemeData['keywords'], params: MemeData['params_type'], min_texts: MemeData['params_type']['min_texts'], max_texts: MemeData['params_type']['max_texts'], min_images: MemeData['params_type']['min_images'], max_images: MemeData['params_type']['max_images'], defText: MemeData['params_type']['default_texts'], args_type: MemeData['params_type']['args_type'], tags: MemeData['tags'], { force }: {
