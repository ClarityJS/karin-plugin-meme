 ...
 */
export declare function add(key: MemeData['key'], info: MemeData, keyWords: MemeData['keywords'], params: MemeData['params_type'], min_texts: MemeData['params_type']['min_texts'], max_texts: MemeData['params_type']['max_texts'], min_images: MemeData['params_type']['min_images'], max_images: MemeData['params_type']['max_images'], defText: MemeData['params_type']['default_texts'], args_type: MemeData['params_type']['args_type'], tags: MemeData['tags'], { force }: {
    force?: boolean | undefined;
}): Promise<import("sequelize").Model<any, any> | [import("sequelize").Model<any, any>, boolean | null]>;
/**
 * 通过 key 查询表情包数据。
 *
 * @param key - 唯一标识符
 * @returns 返回查询到的记录
 */
export declare function get(key: string): Promise<Model | null>;
/**
 * 通过 key 查询指定字段的值。
 *
 * @param key - 表情包的唯一标识符
 ...
 * @returns 返回查询到的数据
 */
export declare function getByKey(key: string, name?: string | string[]): Promise<Model | null>;
/**
 ...
 * @returns 返回符合条件的记录数组
 */
export declare function getByField(field: string, value: string | number | string[] | number[], returnField?: string | string[]): Promise<Model[] | Model>;
/**
 * 通过字段名查询所有不同的值。
 *
 * @param name - 需要查询的字段
