import { col, DataTypes, fn, literal, Op, sequelize } from '../../models/db/base.js';
/**
 ...
 */
export async function add(key, info, keyWords, params, min_texts, max_texts, min_images, max_images, defText, args_type, tags, { force = false }) {
    if (force) {
