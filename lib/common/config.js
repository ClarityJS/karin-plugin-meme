...
class Cfg {
     ...
     * 合并 YAML 对象，确保保留注释
     */
    mergeObjectsWithPriority(userEditor, defaultEditor) {
        let differences = false;
        const mergeYamlNodes = (targetPath, sourceEditor) => {
...
export const Config = new Proxy(Object.assign(new Cfg().initCfg(), {}), {
    get(target, prop) {
        if (prop in target) {
