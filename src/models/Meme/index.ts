...
export async function make (e: Message, memekey:string, userText: string, min_texts: number, max_texts: number, min_images:number, max_images: number, default_texts:string[], args_type: ArgsType) {
